...
export function Button({ 
  ...
  const variants: Record<string, string> = {
    default: "bg-brand hover:bg-blue-600 text-white font-semibold shadow-glow active:scale-[0.98]",
    primary: "bg-brand hover:bg-blue-600 text-white font-semibold shadow-glow active:scale-[0.98]",
    ...
    outline: "border border-border-subtle bg-surface hover:bg-surface-elevated text-text-primary hover:border-brand transition-colors active:scale-[0.98]",
    secondary: "border border-border-subtle bg-surface-elevated text-text-primary hover:bg-surface active:scale-[0.98]",
    ghost: "text-text-secondary hover:text-text-primary hover:bg-surface-elevated active:scale-[0.98]",
    link: "text-brand underline-offset-4 hover:underline",
    signal: "border border-brand/40 bg-brand/10 text-brand hover:bg-brand/20 font-semibold active:scale-[0.98]"
  };
